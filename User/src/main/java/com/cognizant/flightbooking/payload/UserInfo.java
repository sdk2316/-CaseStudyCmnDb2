...
public class UserInfo {
	...
	public UserInfo(Integer id, Integer pnr, String userFirstName, String userLastName, String email, String gender,
	...
	public String toString() {
		return "UserInfo [id=" + id + ", pnr=" + pnr + ", userFirstName=" + userFirstName + ", userLastName="
